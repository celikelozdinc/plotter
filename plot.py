...
def main():
    ...
    green_std = (sub_1.std(),sub_2.mean())
    ...
    """
    green_bar = (_4ReplicaSet_300Events_BaseSoln._mean_restore_duration, _8ReplicaSet_300Events_BaseSoln._mean_restore_duration)
    blue_bar = (_4ReplicaSet_300Events_OurSoln._mean_restore_duration, _8ReplicaSet_300Events_OurSoln._mean_restore_duration)

    green_std = (_4ReplicaSet_300Events_BaseSoln._std_restore_duration,_8ReplicaSet_300Events_BaseSoln._std_restore_duration)
    blue_std = (_4ReplicaSet_300Events_OurSoln._std_restore_duration,_8ReplicaSet_300Events_OurSoln._std_restore_duration)
