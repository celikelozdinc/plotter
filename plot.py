...
def main():
    ...
    green_bar = (_4ReplicaSet_3000Events_DistributedSoln._mean_restore_duration)
    blue_bar = (_4ReplicaSet_3000Events_CentralizedSoln._mean_restore_duration)

    green_std = (_4ReplicaSet_3000Events_DistributedSoln._std_restore_duration)
    blue_std = (_4ReplicaSet_3000Events_DistributedSoln._std_restore_duration)
